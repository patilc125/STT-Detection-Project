...
class SoftTissueTumorClassifier():
    """ Returns a SoftTissueTumorClassifier class object which represents our 
    optimizer for our network.
    """

    def __init__(self, model, device):
        """ Constructor for our SoftTissueTumorClassifier class.
        Parameters:
    ...
    def predict(self, data, threshold=0.5):
        ...
        Returns:
            image(numpy.ndarray): 512x512 Original softtumor scanned image.
